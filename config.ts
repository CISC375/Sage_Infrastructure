...
export const GITHUB_TOKEN = process.env.GITHUB_TOKEN || '';		// ASSUMING THIS IS PROPER ASSIGNMENT
export const GITHUB_PROJECT = process.env.GITHUB_PROJECT || ''; // ASSUMING THIS IS PROPER ASSIGNMENT
